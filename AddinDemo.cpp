...
void WINAPI InitFinishedEx2(HWND hMainFrame, IMainFramework * pApp) {
	...
	int nAutoShow = GetPrivateProfileInt("AddinDemo","AutoShow",   
		0,"C:\\StockCfg.ini"); 
	...
	if(nAutoShow && g_pdlgMainWindow == NULL)
	{
		...
		//在原来位置显示
		int nXPos = GetPrivateProfileInt("AddinDemo","X",   
			0,"C:\\StockCfg.ini"); 
		int nYPos = GetPrivateProfileInt("AddinDemo","Y",   
			0,"C:\\StockCfg.ini"); 
